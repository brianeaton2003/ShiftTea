...
/** Hosts where we may point the client at local emulators (loopback + RFC1918 for LAN dev). */
...
/** Must match the page hostname so Firestore/Auth CORS lines up (localhost ≠ 127.0.0.1 to the browser). */
const emulatorHost =
