...
function SignUpForm() {
  ...
  const signinHref = `/account?redirectTo=${encodeURIComponent(redirectTo)}`;
  ...
  return (
    <div className="flex min-h-0 flex-col">
      ...
      <div className="space-y-3">
        ...
        <form onSubmit={onSubmit} className="space-y-3">
          ...
          <input
            ...
            placeholder="Password (8+ chars, include a number)"
            required
            className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-400"
          />
          <input
      ...
      <p className="text-sm text-center text-gray-500 mt-2 pb-2">
        ...
        <Link prefetch={false} href={signinHref} className="text-orange-500 font-medium">
          Sign in
        </Link>
      </p>
    </div>
