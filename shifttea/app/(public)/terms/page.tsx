  ...
  return (
    <div className="mx-auto max-w-3xl space-y-4 lg:space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-xl font-bold text-gray-900 lg:text-3xl">Terms of Service</h1>
      </div>

      <div className="space-y-3 rounded-xl border border-gray-100 bg-white p-4 shadow-sm lg:rounded-2xl lg:border-black/10 lg:p-8">
